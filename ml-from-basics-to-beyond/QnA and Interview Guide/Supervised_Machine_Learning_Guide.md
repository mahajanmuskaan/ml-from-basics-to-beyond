...
- [Part 0 — The Golden Rule & Foundation](#part-0)
  - [0.1 Split Your Data First](#01-split-your-data-first)
  - [0.2 Feature Scaling — Which Algorithms Need It](#02-feature-scaling)
  - [0.3 One-Line Mental Models for All Algorithms](#03-one-line-mental-models)
- [Part 1 — Linear Regression](#part-1)
  - [1.1 What the Model Learns](#11-what-the-model-learns)
  - [1.2 Error → Loss → Cost Function](#12-error--loss--cost-function)
  - [1.3 Gradient Descent](#13-gradient-descent)
  - [1.4 Regularisation — Ridge, Lasso, ElasticNet](#14-regularisation)
  - [1.5 Evaluation Metrics for Regression](#15-evaluation-metrics-for-regression)
- [Part 2 — Logistic Regression](#part-2)
  - [2.1 The Sigmoid Function](#21-the-sigmoid-function)
  - [2.2 Log Loss — The Cost Function](#22-log-loss--the-cost-function)
  - [2.3 Hyperparameter C](#23-hyperparameter-c)
- [Part 3 — K-Nearest Neighbors (KNN)](#part-3)
  - [3.1 Core Mechanism](#31-core-mechanism)
  - [3.2 Distance Formulae](#32-distance-formulae)
  - [3.3 Hyperparameter K](#33-hyperparameter-k)
- [Part 4 — Support Vector Machine (SVM)](#part-4)
  - [4.1 The Margin — Core Geometry](#41-the-margin--core-geometry)
  - [4.2 Hard Margin vs Soft Margin](#42-hard-margin-vs-soft-margin)
  - [4.3 The Kernel Trick](#43-the-kernel-trick)
  - [4.4 Hyperparameters C and Gamma](#44-hyperparameters-c-and-gamma)
  - [4.5 LR vs SVM — Key Difference](#45-lr-vs-svm--key-difference)
- [Part 5 — Naive Bayes](#part-5)
  ...
  - [5.4 Laplace Smoothing](#54-laplace-smoothing)
- [Part 6 — Decision Tree](#part-6)
  - [6.1 How the Tree Learns — Splitting Criteria](#61-how-the-tree-learns--splitting-criteria)
  - [6.2 Gini, Entropy, Variance Reduction](#62-gini-entropy-variance-reduction)
  - [6.3 Tree Building Algorithm](#63-tree-building-algorithm)
  - [6.4 Hyperparameters — The Pruning Dials](#64-hyperparameters--the-pruning-dials)
- [Part 7 — Random Forest](#part-7)
  - [7.1 Two Randomisation Tricks](#71-two-randomisation-tricks)
  - [7.2 Why Averaging Reduces Variance](#72-why-averaging-reduces-variance)
  - [7.3 Hyperparameters](#73-hyperparameters)
  - [7.4 Feature Importance](#74-feature-importance)
- [Part 8 — XGBoost](#part-8)
  ...
  - [8.4 XGBoost vs Random Forest](#84-xgboost-vs-random-forest)
  - [8.5 LightGBM and CatBoost](#85-lightgbm-and-catboost)
- [Part 9 — Hyperparameter Tuning & Cross-Validation](#part-9)
  ...
  - [9.3 Grid Search, Random Search, Bayesian Optimisation](#93-search-strategies)
  - [9.4 Complete Tuning Pipeline](#94-complete-tuning-pipeline)
- [Part 10 — Bias, Variance & The Tradeoff](#part-10)
  - [10.1 Definitions](#101-definitions)
  - [10.2 The 2-Number Diagnostic Test](#102-the-2-number-diagnostic-test)
  - [10.3 Where Every Algorithm Sits](#103-where-every-algorithm-sits)
- [Part 11 — Evaluation Metrics: Complete Guide](#part-11)
  - [11.1 The Confusion Matrix](#111-the-confusion-matrix)
  - [11.2 All Classification Metrics](#112-all-classification-metrics)
  - [11.3 Regression Metrics](#113-regression-metrics)
  - [11.4 Choosing the Right Metric](#114-choosing-the-right-metric)
  - [11.5 Domain Cheat Sheet](#115-domain-cheat-sheet)
- [Part 12 — Ensemble Methods — The Big Picture](#part-12)
- [Part 13 — Master Comparison Tables](#part-13)
- [Part 14 — Algorithm Selection Decision Guide](#part-14)
- [Part 15 — Quick Revision: All Formulae in One Place](#part-15)
- [Part 16 — Complete Interview Q&A Bank](#part-16)
